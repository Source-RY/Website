    ...
    return (
        <div>
          ...
          <div class="partner-widget-partners">
            ...
            <a class="partner-widget-item" href="https://profitsoftware.com/"><img src={ProfitSoftware} alt="Profit Software Logo"/></a>
            <a class="partner-widget-item" href="https://www.vincit.com/"><img src={Vincit} alt="Vincit Logo"/></a>
            <a class="partner-widget-item" href="https://www.yobaari.com/"><img src={Kaijakka} alt="Kaijakka Logo"/></a>
            <a class="partner-widget-item" href="https://hene.fi/"><img src={Hene} alt="Siniset Bussit Logo"/></a>
            <a class="partner-widget-item" href="https://toas.fi/"><img src={TOAS} alt="TOAS Logo"/></a>
          </div>
            </div>
        </div>
    )
