...
const IndexPage = () => (
  <IndexLayout>
    <h1 className="page-title">Source RY</h1>
    <p className="page-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
    ...
    Proin interdum maecenas massa turpis sagittis in, interdum non lobortis vitae massa.
    ...
    Donec ipsum, vestibulum ullamcorper venenatis augue.
    Aliquam tempus nisi in auctor vulputate, erat felis pellentesque augue nec,
    pellentesque lectus justo nec erat. Aliquam et nisl.
    Quisque sit amet dolor in justo pretium condimentum.</p>
